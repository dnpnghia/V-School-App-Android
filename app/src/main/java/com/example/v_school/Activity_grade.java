...
public class Activity_grade extends AppCompatActivity {
    TextView diemToan, diemVan, diemAnh, diemTong;
...
//                Toast.makeText(Activity_grade.this,listGrade.size()+"",Toast.LENGTH_LONG).show();
    ...
    public void InitUI() {
        diemToan = (TextView) findViewById(R.id.edtToan);
        diemVan = (TextView) findViewById(R.id.edtVan);
        diemAnh = (TextView) findViewById(R.id.edtAnh);
        diemTong = (TextView) findViewById(R.id.edtTong);
